...
├── curation_ab_test_v4_noisy.ipynb             # The validation experiment using proxy (run on Colab)
├── curation_ab_test_v4_noisy_ci_output.ipynb   # The validation experiment using ci output (run on Colab)
